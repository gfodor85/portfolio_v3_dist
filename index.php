...
<body id="bg-move">
    ...
    <div class="panel-wrapper">
        ...
        <!-- WORK PANEL -->
        <div class="content-panel panel-works" id="panel-works">
            <div id="panel-icon_2" class="panel-icon panel-icon_2 active">
                <svg class="panel-svg">
        ...
        <!-- SKILLS PANEL -->
        <div class="content-panel panel-skills" id="panel-skills">
            <div id="panel-icon_3" class="panel-icon panel-icon_3 active">
                <svg class="panel-svg">
            ...
            <div id="title-container_3" class="title-container active">
